...
//        return BuildType.DEBUG.equals(AppMaster.getInstance().getBuildType())
//                || BuildType.QA.equals(AppMaster.getInstance().getBuildType())
//                || BuildType.QA_4_DEV.equals(AppMaster.getInstance().getBuildType())
//                || BuildType.STAGING_4_DEV.equals(AppMaster.getInstance().getBuildType())
//                || BuildType.PRODUCT_4_DEV.equals(AppMaster.getInstance().getBuildType());
//                || BuildType.PRODUCT.equals(AppMaster.getInstance().getBuildType());
        return false;
    }

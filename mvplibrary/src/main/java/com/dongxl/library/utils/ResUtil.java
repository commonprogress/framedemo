...
public class ResUtil {
    ...
    public static String[] getStringArray(@ArrayRes int resId) {
        return AppMaster.getInstance().getAppContext().getResources().getStringArray(resId);
    }
    ...
    public static ColorStateList getColorStateList(@ColorRes int resId) {
        return ContextCompat.getColorStateList(AppMaster.getInstance().getAppContext(), resId);
    }
...
//        gradient = gradient < 0.1F ? MIN_ALPHA : gradient;
    ...
    public static int[] getResArray(@ArrayRes int arrayResId) {
        TypedArray typedArray = AppMaster.getInstance().getAppContext().getResources().obtainTypedArray(arrayResId);
